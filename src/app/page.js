        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-suto  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">
              SMART SPACE BUILD AUTOMATIONS, IS AN AUTOMATION COMPANY WHICH AUTOMATES YOUR SPACE, EXAMPLE HOME, OFFICE, INDUSTRIES
              CHECK OUT OUR PRODUCTS AND INSTALLATION BY OUR AGENTS IS ALSO AVAILABLE ALONG WITH 24/7 SERVICE
            </p>
          ...
          <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img
              src="https://ssblinktech.me/pic.png"
